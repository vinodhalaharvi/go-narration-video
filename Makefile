...
init:  ## Create placeholder generated files so the project compiles before first build
	...
	@test -f $(META) || echo '{"durationSec":5,"format":"long","title":"","introIcon":"","introText":"","typewriter":"","typewriterReveals":[],"viz":"","vizStartSec":0,"outputStyle":"","outputLines":[],"introUntilSec":0,"outroIcon":"","outroText":"","outroStartSec":0}' > $(META)
